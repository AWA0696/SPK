         ...
         <div class="col-lg-12">
             <div class="card shadow">
                 <div class="card-header" style="background-color: #17a2b8;">
                     <h6 class="m-0 font-weight-bold text-white">Input SPK</h6>
                 </div>
                 <div class="card-body">
                     <form method="post" action="<?= base_url('Database_spk/simpan_spk') ?>" class="form-horizontal"
                         ...
                         <div class="row mb-3">
                             <div class="col-12">
                                 <input type="date" class="form-control" name="tanggal_awal_spk" id="tanggal_awal_spk"
                                     required>
                             </div>
                         </div>
                         ...
                         <div class="row mb-3">
                             <div class="col-12">
                                 <input type="date" class="form-control" name="tanggal_akhir_spk" id="tanggal_akhir_spk"
                                     required>
                             </div>
                         </div>
                         ...
                         <div class="row mb-3">
                             <div class="col-12">
                                 <textarea class="form-control" rows="5" id="rincian" name="rincian"></textarea>
                             </div>
                         </div>
                 ...
                 <div class="row">
                     <div class="col-1	">
                         <button type="submit" class="btn btn-info btn-icon-split ml-4 mb-4">
                             <span class="icon text-white-50">
