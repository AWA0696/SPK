              ...
              $nilai_pencairan=$row->pencairan;
                ...
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 1</label>
                        </div>
                        <div>
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 2</label>
                        </div>
                        <div>
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 3</label>
                        </div>
                        <div>
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 4</label>
                        </div>
                        <div>
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 5</label>
                        </div>
                        <div>
                ...
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 6</label>
                        </div>
                        <div>
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 7</label>
                        </div>
                        <div>
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 8</label>
                        </div>
                        <div>
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 9</label>
                        </div>
                        <div>
                    ...
                    <div style="text-align: center;">
                        <div>
                            <label for="" class="control-label col">Foto 10</label>
                        </div>
                        <div>
