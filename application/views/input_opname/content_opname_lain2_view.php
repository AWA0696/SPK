        ...
        <div class="col-lg-12">
            <div class="card shadow">
                <div class="card-header bg-light">
                    <h6 class="m-0 font-weight-bold text-dark-100">Input Opname Lain - Lain</h6>
                </div>
                <div class="card-body">
                    <form method="post" action="<?= base_url('Database_spk/simpan_opname_lain2_view') ?>"
                        class="form-horizontal" enctype="multipart/form-data" id='opname_lain2'>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <input readonly type="text" class="form-control" name="sisa_pencairan"
                                    id="sisa_pencairan" value="<?=$this->pitih->formatrupiah($selisih_spk )?>" required>
                            </div>
                        </div>
