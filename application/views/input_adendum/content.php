        ...
        <div class="col-lg-12">
            <div class="card shadow">
                <div class="card-header bg-light">
                    <h6 class="m-0 font-weight-bold text-dark-100">Input Adendum</h6>
                </div>
                <div class="card-body">
                    <form method="post" action="<?= base_url('Database_spk/simpan_adendum') ?>" class="form-horizontal"
                        id="input_data_konsumen">

                        <label for="" class="col-12 col-form-label">Nama Konsumen</label>
                        <div class="row mb-3">
                            <div class="col-12">
                                <input hidden type="text" name="id_table_spk" class="form-control"
                                    value="<?php echo $tampil_perumahan_dan_blok->id_table_spk; ?>">
                                <input type="text" class="form-control" name="nama_konsumen_adendum">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <input readonly type="text" class="form-control" name="tanggal_input_adendum" id=""
                                    value="<?php echo date('d F Y');  ?>" required>
                            </div>
                        </div>

                        <label for="" class="col-12 col-form-label">Alamat</label>
                        <div class="row mb-3">
                            <div class="col-12">
                        ...
                        <label for="" class="col-12 col-form-label">No HP/Telp</label>
                        <div class="row mb-3">
                            <div class="col-12">
                                <input type="text" class="form-control" name="no_telp" id="" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <textarea class="form-control" rows="5" id="" name="rincian_adendum"></textarea>
                            </div>
                        </div>
