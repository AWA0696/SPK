    <div class="container-fluid">
        <div class="card shadow">
            <div class="card-header bg-light m-0 font-weight-bold text-white">
                <a onclick="location.href = ('<?php echo site_url('Database_spk/perumahan_spmb/') ?>')"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="spmbDropdown">
                                            <a class="dropdown-item"
                                                href="<?= site_url('Database_spk/list_spmb_view/') . $t->id_table_spk; ?>"
                                                name="spmbButton">
                                                Detail SPMB
                                            </a>
                                            ...
                                            <a class="dropdown-item" id="retensi<?php echo $t->id_table_spk; ?>"
                                                href="<?= site_url('Database_spk/input_pengurangan_retensi_view/') . $t->id_table_spk; ?>"
                                                name="retensi">
                                                Input Retensi
                                            </a>
                                            ...
                                            <a class="dropdown-item" id="detailRetensi<?php echo $t->id_table_spk; ?>"
                                                href="<?= site_url('Database_spk/list_retensi_view/') . $t->id_table_spk; ?>"
                                                name="detailRetensi">
                                                Detail Retensi
                                            </a>
                                        </div>
