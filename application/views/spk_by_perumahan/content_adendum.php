    <div class="container-fluid">
        <div class="card shadow">
            <div class="card-header bg-light m-0 font-weight-bold text-white">
                <a onclick="location.href = ('<?php echo site_url('Database_spk/perumahan_adendum/') ?>')"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="opnameDropdown">
                                            <a class="dropdown-item"
                                                href="<?= site_url('Database_spk/input_adendum_view/') . $t->id_table_spk; ?>">Input
                                            </a>
                                            <a class="dropdown-item"
                                                href="<?= site_url('Database_spk/list_adendum_view/') . $t->id_table_spk; ?>">Print
                                                Adendum</a>
                                        </div>
                                    </div>
                                </td>
