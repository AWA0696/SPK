...
$(document).ready(function() {
    ...
    function listdata() {
        $.ajax({
            type: 'ajax',
            url: "<?= base_url('Database_spk/data_temp_koreksi_pengurangan_retensi') ?>",
            async: false,
            dataType: 'json',
    ...
    $('#form_koreksi').submit('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('Database_spk/simpan_temp_koreksi_pengurangan_retensi') ?>",
            dataType: "JSON",
            data: {
                koreksi: koreksi,
    ...
    $('#delete-koreksi').on('submit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('Database_spk/hapus_temp_koreksi_pengurangan_retensi') ?>",
            dataType: "JSON",
            data: {
                id: UserId
            },
