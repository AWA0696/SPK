<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-header " style="background-color: #17a2b8;">
            <h6 class="m-0 font-weight-bold text-white">Adendum</h6>
        </div>
                ...
                <table id="table_his" class="table table-bordered">
                    ...
                    <tbody>
						...
						foreach ($tampil as $data) {
							...
							echo "<td><a href='" . base_url('Database_spk/spk_by_perumahan_adendum/') . $data->id_perumahan . "'>" . $data->nama_perumahan . "</a></td>";
